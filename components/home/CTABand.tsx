        ...
        <div className="relative grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-5 font-display font-black tracking-tightest text-5xl md:text-6xl lg:text-[80px] leading-[0.92]">
              ...
              {t('titleLine2')}
              <br />
              <em className="not-italic italic font-light">{t('titleAccent')}</em>{t('titleEnd')}
            </h2>
            <p className="mt-6 text-paper/80 text-lg max-w-md leading-relaxed">{t('intro')}</p>
          ...
          <div className="lg:col-span-5 relative h-[300px] md:h-[400px]">
            <div className="absolute top-0 right-4 polaroid rotate-[6deg] w-[78%]">
              <Image src="/images/seesaw.jpg" alt={t('altSeesaw')} width={500} height={400} className="w-full h-[200px] md:h-[260px] object-cover" />
            ...
            <div className="absolute bottom-0 left-0 polaroid -rotate-[5deg] w-[60%] z-10">
              <Image src="/images/bees.jpg" alt={t('altBees')} width={500} height={400} className="w-full h-[150px] md:h-[180px] object-cover" />
            </div>
          </div>
        </div>
      </div>
